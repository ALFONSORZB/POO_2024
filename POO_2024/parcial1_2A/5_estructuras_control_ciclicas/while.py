#El Ciclo WHILE Estructura iterativa que se ejecuta X veces siempre y 
#cuando la condicion se cumpla y se seguira ejecutando tantas veces como sea posible True la condicion
